        ...
        <div class="drag-and-drop" x-data="{ adding: false, removing: false }">
            <div class="drag-and-drop__container drag-and-drop__container--from">
                ...
                <ul class="drag-and-drop__items" :class="{ 'drag-and-drop__items--removing': removing }"
                    ...
                    x-on:drop.prevent="const target = event.target.closest('ul');
                    ...
                    <li id="item-4" class="drag-and-drop__item"
                        :class="{ 'drag-and-drop__item--dragging': dragging }"
                        x-on:dragstart.self="
                            dragging = true;
                            event.dataTransfer.effectAllowed='move';
                    ...
                    <li id="item-5" class="drag-and-drop__item"
                        :class="{ 'drag-and-drop__item--dragging': dragging }"
                    ...
                    <li id="item-6" class="drag-and-drop__item"
                        :class="{ 'drag-and-drop__item--dragging': dragging }"
                        x-on:dragstart.self="dragging = true;
                        event.dataTransfer.effectAllowed='move';
                        event.dataTransfer.setData('text/plain', event.target.id);"
            ...
            <div class="drag-and-drop__container drag-and-drop__container--to">
                ...
                <ul class="drag-and-drop__items" :class="{ 'drag-and-drop__items--adding': adding }"
